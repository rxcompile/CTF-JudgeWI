			...
			<?php				
				if(($_GET['page'])&&($_GET['page'] < 10)){
					...
					$array = array(
							...
							'<a href="/?page=2">Новости</a>',
							'<a href="/?page=3">Правила</a>',
							'<a href="/?page=4">Регистрация</a>',
							'<a href="/?page=5">Участники</a>',
							'<a href="/?page=6">Разработчики</a>',
							'<a href="/?page=7">Публичный скорборд</a>'
							);
					for($s=0; $s<($page-1); $s++){
						echo '<li>'.$array[$s].'</li>';
					}
